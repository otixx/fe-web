          ...
          <div className="p-4 shadow-lg w-full lg:w-2/5 justify-start">
            ...
            <form onSubmit={handleLogin}>
              <div className='flex justify-center p-2'>
                <h1 className='font-bold text-[21px] text-mainColors'>Masuk ke akunmu</h1>
              </div>
              <div className="flex gap-2 justify-center p-2">
                <div className="text-[#666666] text-[14px]">Tidak punya akun ?</div>
                <Link to="/signup">
                  <div className="text-[14px] cursor-pointer font-bold text-mainColors">Daftar</div>
                </Link>
              </div>
              <div className="mb-6">
              ...
              <div className="mb-6">
                <div className="flex justify-between  gap-4 items-center">
                  ...
                  <Link to={'/forgot-password'}>
                    <label className="block cursor-pointer text-[14px] font-medium hover:text-hoverMainColors text-secondColors ">Lupa Kata Sandi ?</label>
                  </Link>
                </div>
