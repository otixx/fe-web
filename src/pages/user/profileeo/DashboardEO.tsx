...
const DashboardEO = () => {
    ...
    const handleAddEvents = async () => {
        ...
        await axios.post(`${import.meta.env.VITE_URL}event`, {
            nama_acara: acara,
                                    ...
                                    dataEvent.map((element, index) => (
                                        <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700" key={index}>
                                            ...
                                            <td className="flex gap-4 text-center px-6 py-4">
                                                <div onClick={() => navigate('/profile/eo/events/12')} className="font-medium cursor-pointer text-blue-600 dark:text-blue-500 hover:underline">View</div>
                                                <div className="font-medium cursor-pointer text-blue-600 dark:text-blue-500 hover:underline">Delete</div>
                                            </td>
                                        </tr>
                                    ))
                                }
